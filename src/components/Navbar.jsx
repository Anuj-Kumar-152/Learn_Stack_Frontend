...
//    // 🔥 AUTO CLOSE WHEN USER CHANGES (login/update/logout)
//    useEffect(() => {
//       setOpenMenu(false);
//    }, [user]);
...
//    return (
//       <div className="fixed top-0 left-0 w-full h-14 sm:h-16 bg-white/90 backdrop-blur-md border-b shadow-sm z-50">
...
//                      onKeyDown={handleEnter}
//                      placeholder="Search Java topics..."
//                      className="w-full bg-gray-100 border border-gray-200 rounded-xl pl-9 pr-4 py-2 text-sm outline-none focus:ring-2 focus:ring-indigo-500"
//                   />

//                   {results.length > 0 && (
//                      <div className="absolute top-11 w-full bg-white border rounded-xl shadow-lg max-h-60 overflow-y-auto z-50">
//                         {results.map((topic, i) => (
//                            <div
//                               key={i}
//                               onClick={() => openTopic(topic)}
...
//                         className="text-xs sm:text-sm px-3 sm:px-4 py-1.5 border rounded-lg"
//                      >
//                         Login
//                      </button>
...
//                         className="text-xs sm:text-sm px-3 sm:px-4 py-1.5 bg-indigo-600 text-white rounded-lg"
//                      >
//                         Signup
//                      </button>
//                   </>
...
//                         }
//                         onClick={() => setOpenMenu(!openMenu)}
//                         className="w-8 h-8 sm:w-9 sm:h-9 rounded-full cursor-pointer border-2 border-indigo-500"
//                      />

//                      {openMenu && (
//                         <div className="absolute right-0 mt-2 w-44 sm:w-48 bg-white border rounded-xl shadow-lg">

//                            <div className="px-3 sm:px-4 py-3 text-xs sm:text-sm border-b">
//                               @{user?.username}
//                            </div>
...
//                            <button
//                               onClick={handleLogout}
//                               className="w-full text-left px-3 sm:px-4 py-2 hover:bg-red-50 text-xs sm:text-sm text-red-500"
//                            >
//                               Logout
//                            </button>
...
//          {/* MOBILE MENU */}
//          {mobileMenu && (
//             <div className="md:hidden bg-white border-t px-3 py-4 space-y-3">
